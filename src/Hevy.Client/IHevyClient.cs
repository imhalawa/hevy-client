...
public interface IHevyClient
{
  ...
  Task<ExerciseHistoryWindow> GetExerciseHistoryWindowAsync(string exerciseTemplateId, ExerciseHistoryWindowRequest request, CancellationToken cancellationToken);

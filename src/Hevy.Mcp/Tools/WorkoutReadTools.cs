...
internal static class WorkoutReadTools
{
  ...
  internal static async Task<CallToolResult> GetWorkouts(
  ...
  internal static async Task<CallToolResult> GetWorkoutCount(IServiceProvider services, CancellationToken cancellationToken = default)
  {
  ...
  internal static async Task<CallToolResult> GetWorkoutEvents(
      IServiceProvider services,
  ...
  internal static async Task<CallToolResult> GetWorkout(
      IServiceProvider services,

...
public sealed class ToolOutputSchemaTests
{
  ...
  public async Task EveryOperationStructuredContentMatchesItsAdvertisedOutputSchema()
  {
    ...
    var cases = new List<(Type Type, string Method, CallToolResult Result)>
    {
      ...
      (typeof(WorkoutWriteTools), nameof(WorkoutWriteTools.CreateWorkout), await WorkoutWriteTools.CreateWorkout(services, FixtureFactory.CreateWorkoutCommand(), true, default)),
      (typeof(WorkoutWriteTools), nameof(WorkoutWriteTools.UpdateWorkout), await WorkoutWriteTools.UpdateWorkout(services, "workout-1", FixtureFactory.UpdateWorkoutCommand(), null, true, true, default)),
      ...
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.CreateRoutine), await RoutineWriteTools.CreateRoutine(services, FixtureFactory.CreateRoutineCommand(), true, default)),
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.UpdateRoutine), await RoutineWriteTools.UpdateRoutine(services, "routine-1", FixtureFactory.UpdateRoutineCommand(), null, true, true, default)),
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.CreateRoutineFolder), await RoutineWriteTools.CreateRoutineFolder(services, FixtureFactory.CreateRoutineFolderCommand(), true, default)),
      ...
      (typeof(ExerciseWriteTools), nameof(ExerciseWriteTools.CreateExerciseTemplate), await ExerciseWriteTools.CreateExerciseTemplate(services, FixtureFactory.CreateExerciseTemplateCommand(), true, default)),
      ...
      (typeof(MeasurementWriteTools), nameof(MeasurementWriteTools.CreateBodyMeasurement), await MeasurementWriteTools.CreateBodyMeasurement(services, FixtureFactory.NewBodyMeasurement(), true, default)),
      (typeof(MeasurementWriteTools), nameof(MeasurementWriteTools.UpdateBodyMeasurement), await MeasurementWriteTools.UpdateBodyMeasurement(services, end, FixtureFactory.BodyMeasurementUpdate(), null, true, true, default)),
      ...
      (typeof(WorkoutWriteTools), nameof(WorkoutWriteTools.CreateWorkout), await WorkoutWriteTools.CreateWorkout(services, FixtureFactory.CreateWorkoutCommand(), false, default)),
      (typeof(WorkoutWriteTools), nameof(WorkoutWriteTools.UpdateWorkout), await WorkoutWriteTools.UpdateWorkout(services, "workout-1", FixtureFactory.UpdateWorkoutCommand(), null, true, false, default)),
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.CreateRoutine), await RoutineWriteTools.CreateRoutine(services, FixtureFactory.CreateRoutineCommand(), false, default)),
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.UpdateRoutine), await RoutineWriteTools.UpdateRoutine(services, "routine-1", FixtureFactory.UpdateRoutineCommand(), null, true, false, default)),
      (typeof(RoutineWriteTools), nameof(RoutineWriteTools.CreateRoutineFolder), await RoutineWriteTools.CreateRoutineFolder(services, FixtureFactory.CreateRoutineFolderCommand(), false, default)),
      (typeof(ExerciseWriteTools), nameof(ExerciseWriteTools.CreateExerciseTemplate), await ExerciseWriteTools.CreateExerciseTemplate(services, FixtureFactory.CreateExerciseTemplateCommand(), false, default)),
      (typeof(MeasurementWriteTools), nameof(MeasurementWriteTools.CreateBodyMeasurement), await MeasurementWriteTools.CreateBodyMeasurement(services, FixtureFactory.NewBodyMeasurement(), false, default)),
      (typeof(MeasurementWriteTools), nameof(MeasurementWriteTools.UpdateBodyMeasurement), await MeasurementWriteTools.UpdateBodyMeasurement(services, end, FixtureFactory.BodyMeasurementUpdate(), null, true, false, default)),
      (typeof(MeasurementWriteTools), nameof(MeasurementWriteTools.UpdateBodyMeasurement), await MeasurementWriteTools.UpdateBodyMeasurement(services, end, FixtureFactory.BodyMeasurementUpdate(), since, false, false, default)),
